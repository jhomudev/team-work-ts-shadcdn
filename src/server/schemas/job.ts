...
export const jobInputSchema = z.object({
  ...
  employerId: z
    .number({
      required_error: 'EmployerId is required',
      invalid_type_error: 'EmployerId must be a number'
    })
    .int('EmployerId must be an integer')
    .positive('EmployerId invalid, must be positive'),
...
export const jobInputUpdateSchema = z.object({
  title: z
    .string({
      required_error: 'Title is required',
      invalid_type_error: 'Title must be a string'
...
export type JobInputUpdateSchemaType = z.infer<typeof jobInputUpdateSchema>